...
- `files/99_diagnostico.md` — Sprint 0 data-quality diagnostic generated by `migrar.py`
  against the real Marval source files (masters with stale/missing/inconsistent data).
...
The only runnable code lives under `files/presupuesto-obra-skill/presupuesto-obra/`.
Everything else is markdown documentation/specs.
